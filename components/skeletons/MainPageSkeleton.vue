<template>
  <div class="flex items-center w-full flex-col gap-10 page-section lg:flex-row lg:gap-4">
    <div class="mt-[40px] flex-[2] flex flex-col gap-3 w-full">
      <div class="h-[40px] w-6/12 skeleton-text skeleton-element"></div>
